...
NOTICE = r'''\
Copyright \copyright 2013 OpenNebula Project, C12G Labs. All rights reserved.

Although the information in this document has been carefully reviewed, the
OpenNebula Project does not warrant it to be free of errors or omissions. The
Project reserves the right to make corrections, updates, revisions, or changes
to the information in this document. The OpenNebula Guides are licensed under a
Creative Commons Attribution-NonCommercial-Share Alike License. You may obtain a
copy of the License at http://creativecommons.org/licenses/by-nc-sa/3.0/

Unless required by applicable law or agreed to in writing, software distributed
under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR
CONDITIONS OF ANY KIND, either express or implied. See the License for the
specific language governing permissions and limitations under the License.
OpenNebula is licensed under the Apache License, Version 2.0 (the "License");
you may not use the software except in compliance with the License. You may
obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0

C12G and OpenNebula are trademarks in the European Union. All other trademarks
...
BEGIN_DOC = begin_doc_1 + begin_doc_2 + begin_doc_3
